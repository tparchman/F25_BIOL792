...
You can either hardcode the name of the file (especially if you are using jupyter) or you can use `sys.argv` to open a file object from the command line. Write to an output file:
...
**D. Lastly have your program print to screen the number of DNA sequences (keep a running count, something like TotalSeq += 1, for each time you process a DNA sequence) and the average GC content over all of the sequences.**
